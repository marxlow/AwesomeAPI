...
var _coinbaseRouter = __webpack_require__(9);
...
var _gdaxRouter = __webpack_require__(12);
...
var _twitterRouter = __webpack_require__(26);
...
var _coinbase = __webpack_require__(10);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _coinbase2.default.prices.getAll({ currency: currency });
...
var _gdax = __webpack_require__(13);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            currency = req.params.currency;
            _context.next = 4;
            return _gdax2.default.prices.getAll({ currency: currency });
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log('> Trying to get Gdax prices for Currency :', currency);
                // Gdax only accepts currency ending with "USD"
                transformCurrency(currency);

                // Initialize server with transformed currency
                _context.next = 4;
                return initializeServer(currency);
