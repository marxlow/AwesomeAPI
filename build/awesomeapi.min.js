...
var _momentTimezone = __webpack_require__(13);
...
_arbitrage2.default.btc.calculate(20000);
...
var _currency = __webpack_require__(12);
...
var _timeLog = __webpack_require__(2);
...
var _gdax = __webpack_require__(16);
...
var _twitter = __webpack_require__(29);
  ...
  this.btc = {
    calculate: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(capital) {
        var profitRate, currencyExchangeRates, usdToSgd, sgdToUsd, usdCryptoPrices, btcToUsd, usdToBtc, sgdBtcExchangeRates, btcToSgd, sgdToBtc, btcSoldForSgd, usdRevenue, btcSoldForUsd, sgRevenue;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
